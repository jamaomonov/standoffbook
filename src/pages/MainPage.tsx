...
const MainPage: React.FC = () => {
  ...
  return (
    <MainLayout>
      <div className="container mx-auto py-5 px-3 md:py-8 md:px-0">
        {/* Hero and Event Section */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          {/* Hero Section */}
          <div className="md:col-span-2 bg-gradient-to-r from-csm-blue-primary to-csm-bg-card rounded-xl p-6 md:p-10 relative overflow-hidden">
          ...
          {/* Event Section */}
          <div className="bg-csm-bg-card rounded-xl p-5 border border-csm-border text-sm">
            <div className="flex justify-between items-start mb-4">
              <div className="flex items-center gap-2">
                <h2 className="text-xl font-bold text-white">Events</h2>
              </div>
              <img src="/src/assets/images/standoff2logo.png" alt="standoff2logo" className="w-24" />
            </div>
            
            <div>
              <div className="flex items-center gap-2 mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-csm-text-secondary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                </svg>
                <h3 className="text-white font-semibold text-lg">BLAST.tv Austin Major 2025</h3>
              </div>
              ...
              <div className="flex flex-col gap-4">
                <div className="flex gap-4 mt-3">
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-white">Jun 3 - Jun 22</span>
                  </div>
                  <div className="flex items-center gap-1">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-csm-text-secondary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
